...
:::danger
The [Wordpress Page](/other/imbit_brillianideas) is not documentated, neither is there a repository on GitHub. A backup might be advisable.
:::
...
- **Applications Affected**: BrillianQUIZ ([Important Info äää](/brillianquiz)), BrillianCRM, and BrillianICM.
