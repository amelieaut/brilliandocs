...
### Markdown and MDX
For guidance on writing Markdown and MDX, reference the [Docusaurus Markdown Features](https://docusaurus.io/docs/markdown-features) guide. Alternatively, ask ChatGPT for assistance with MDX syntax.
...
### Deployment
BrillianDocs is hosted as a public repository on GitHub Pages. The official URL is https://imbit-mannheim.github.io/brilliandocs, but access through this link is not intended and is broken knowingly.
...
- **Branding**: Integrate Brillian branding elements, such as replacing the default logo with the Brillian octopus icon, and update the color scheme and fonts to align with the brand identity.
